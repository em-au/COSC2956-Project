...
<?php 
    // SQL statement to retrieve books for a user
        ...
        <div class="d-flex gap-2">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item disabled" aria-disabled="true">Read</a></li>
                </ul>
            </div>
        ...
        <?php 
            if ($result) { 
                if (mysqli_num_rows($result) == 0) {
                    echo "<i>You have no books marked as 'read'</i><br><br>";
                }
            }
